...
sed -e 's/^/<fpc4:Str dt:dt="string">https:\/\//' removed_tabs_and_spaces.txt > inserted_prefix.txt
...
sed '/<fpc4:URLStrings>/ r ip-blacklist.xml' sample_tmg_https.xml > final_https.xml
